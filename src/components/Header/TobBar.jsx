      ...
      <div className="w-full bg-purple-600 text-white py-2">
        <div className="container mx-auto px-4 flex flex-col md:flex-row justify-between items-center">
          <div className="flex flex-col md:flex-row items-center space-y-2 md:space-y-0 md:space-x-6 text-sm">
            <a href="mailto:info@hekto.com" className="flex items-center hover:text-purple-200 transition-colors">
              <Mail size={16} className="mr-2" />
              <span>info@hekto.com</span>
            </a>
            <a href="tel:+1234567890" className="flex items-center hover:text-purple-200 transition-colors">
          ...
          <div className="flex items-center space-x-6 text-sm mt-2 md:mt-0">
            ...
            <Link to="/wishlist" className="flex items-center hover:text-purple-200 transition-colors relative group">
            ...
            <Link to="/cart" className="flex items-center hover:text-purple-200 transition-colors relative group">
